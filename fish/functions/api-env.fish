function api-env --description 'switch or show the current API env'
    ...
    for v in API_BASE_URL API_AUTH_TYPE API_TOKEN_URL API_CLIENT_ID API_CLIENT_SECRET API_SCOPE API_TOKEN_AUTH_STYLE API_USERNAME API_PASSWORD API_KEY API_KEY_HEADER API_EXTRA_ARGS
        set -e $v
    end
